      ...
      <VStack maxW="1200px" mx="auto" px={{ base: 6, md: 10 }} gap={12}>
        <VStack gap={3} textAlign="center">
          <Heading as="h2" fontSize={{ base: '2xl', md: '3xl' }} fontWeight="900" color="#0A1628">
            Beneficios de <TextoGradiente fontWeight="900" fontSize={{ base: '2xl', md: '3xl' }}>Impacto Real</TextoGradiente>
          </Heading>
          <Text color="gray.500" fontSize="sm" maxW="480px" lineHeight="tall">
            Diseñado para maximizar la eficiencia y seguridad de tu institución
        ...
        <Flex direction={{ base: 'column', sm: 'row' }} wrap="wrap" gap={6} justify="center" w="full">
          {beneficios.map((b) => (
            ...
            >
              <CardBeneficio icono={b.icono} titulo={b.titulo} descripcion={b.descripcion} />
            </Box>
          ))}
        </Flex>
      </VStack>
